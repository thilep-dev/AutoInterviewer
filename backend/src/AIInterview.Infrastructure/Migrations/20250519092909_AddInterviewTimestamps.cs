...
{
    /// <inheritdoc />
    public partial class AddInterviewTimestamps : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CodeSubmissionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestCase_CodeSubmissions_CodeSubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestCase_CodeSubmissionId",
                table: "TestCase",
